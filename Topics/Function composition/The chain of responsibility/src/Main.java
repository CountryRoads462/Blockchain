...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInTransactionTag.handle(createDigest.getData()).handle(wrapInRequestTag.getData());
    ...
    interface RequestHandler {
        ...
        RequestHandler handle(Request anotherRequest);
